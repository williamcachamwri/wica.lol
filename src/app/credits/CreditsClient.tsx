                ...
                {filteredTechnologies.map((tech, index) => (
                  ...
                  >
                    <motion.a
                      ...
                      className="block relative p-6 rounded-lg border border-zinc-800 bg-zinc-900/30 transition-all duration-500 group-hover:shadow-[0_0_30px_rgba(52,211,153,0.3)] overflow-hidden" 
                    ...
                    >
                      ...
                      <motion.div 
                        className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 backdrop-blur-sm bg-gradient-to-br from-green-300/10 to-transparent rounded-lg pointer-events-none" 
                        initial={{ opacity: 0 }}
                        whileHover={{ opacity: 1 }}
                      />

                      <motion.div 
                        className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden pointer-events-none" 
                        initial={{ opacity: 0 }}
                        whileHover={{ opacity: 1 }}
                      >
                        <motion.div 
                      ...
                      <motion.div 
                        className="absolute top-3 right-3 w-2 h-2 rounded-full bg-green-300/50 opacity-0 group-hover:opacity-100 pointer-events-none" 
