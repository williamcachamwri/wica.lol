...
const edu = [
  {
    title: "Giong Ong To High School",
    position: "Grade 11 student (biology survivor)",
    date: "(2022 - present)",
    description:
      "currently surviving high school, mixing up chemical formulas and daydreaming about building random projects",
    link: "https://thptgiongongto.hcm.edu.vn/homemb",
    color: "#60a5fa",
  },
];
